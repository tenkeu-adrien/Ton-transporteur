...
export async function POST(req: Request) {
  ...
  const mailOptions = {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px;">
      <h2 style="color: #f96d06; text-align: center;">Bienvenue sur Ton Transporteur ! 🚛</h2>
      <p>Bonjour,</p>
      <p>Nous sommes ravis de vous compter parmi nous sur <strong>Ton Transporteur</strong>, la plateforme qui facilite vos envois et déménagements en toute simplicité.</p>
      ...
      <p style="text-align: center;">⚠️ Ce code expirera dans <strong>30 minutes</strong>.</p>
      
      <p>Si vous n'êtes pas à l'origine de cette demande, ignorez simplement cet email.</p>
      
      <p>À très bientôt sur <strong>Ton Transporteur</strong> ! 🚀</p>
