      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">
            Déménagez facilement et rapidement de Marseille à Toulouse avec Ton-transporteur
          </h2>
          <div className="prose max-w-none text-gray-600">
            <p>
              Vous prévoyez un déménagement entre Marseille et Toulouse? Ne cherchez plus, Ton-transporteur est là pour vous offrir un service professionnel et sécurisé qui vous facilitera la vie!
            </p>
            <p>
