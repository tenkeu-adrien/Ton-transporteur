      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            Envoyer votre scooter avec Ton-transporteur
            </h1>
      ...
      <section className="py-12">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800">
            Comment expédier votre scooter ?
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Proposez votre scooter à l'envoi. Détaillez votre annonce avec l'adresse, les dimensions et le prix
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              ...
              scooter (prix, date d'enlèvement et de livraison).
            </p>
          </div>
            ...
            <div key={index} className="bg-gray-50 p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                <div className="bg-gray-200 rounded-full w-12 h-12 flex items-center justify-center">
                  <svg className="w-[100px] h-[80px] text-gray-500" fill="currentColor" viewBox="0 0 20 20">
