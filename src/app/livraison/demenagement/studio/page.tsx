      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <h1 className="text-[100px] md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
            Déménager un studio  avec Ton-transporteur
            </h1>
  ...
  <g id="Group_64" data-name="Group 64" transform="translate(-600.001 -166)">
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="py-12">
        ...
        Déménagez votre studio avec Ton-transporteur
        </h2>
        
        <p className="text-gray-600 mb-6">
        De nombreux particuliers ou professionnels passent par Ton-transporteur pour faire le déménagement de leur studios. Les étudiants font souvent appel à Ton-transporteur pour faire leur déménagement étudiant pour pas cher. En effet souvent un déménagement d'appartement est très cher. Grâce au covoiturage de colis, vous pouvez faire votre déménagement de studio pour pas cher, à un prix défiant toute concurrence pourrait-on même dire. Que votre studio soit F1, T1, F2, T2 ce n'est pas un problème! Un voyageur s'occupera de faire la livraison de votre studio à travers toute la France. Pour déménager votre studio en toute simplicité, Ton-transporteur vous propose un service adapté à vos besoins. Vous êtes étudiant ou appréciez les avantages du studio, un déménagement peut s'avérer onéreux
         et difficilement accessible avec les déménageurs professionnels. Ton-transporteur vous permet de profiter du transport de vos meubles et cartons pour peu cher.
        </p>
      ...
      <section className="py-12">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-8">
        Un transporteur spécial pour vos demandes
        </h2>
        
        <p className="text-gray-600 mb-6">
        En fonction des objets que vous désirez faire transporter jusqu'à votre nouvelle adresse, choisissez 
le transporteur qui saura le mieux répondre à vos attentes. Partout en France, il est possible de profiter des services de la plateforme en 
ligne. Pour ce faire, posez une annonce intelligible et joignez un déménageur disponible pour le trajet à effectuer. La quantité de matériel à 
déménager doit être spécifiée afin d'adapter immédiatement la taille du véhicule qui se chargera du transport.Tout type de transporteur pourra se
 porter volontaire, vous pouvez préciser au préalable les dimensions et poids de vos meuble
        </p>
...
<section className="py-12">
        <div className="text-center mb-12">
          ...
          Comment déménager votre studio?
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Proposez  une demande du déménagement de votre studio . Détaillez votre annonce avec l'adresse, les dimensions et le prix
              proposé pour la livraison. Pensez à ajouter une photo de votre studio.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Les voyageurs vous contactent par texto ou mail. Mettez-vous d'accord sur les détails du déménagements de votre studio  (prix, date d'enlèvement et de livraison).
            </p>
          </div>
