      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            Déménager une maison avec Ton-transporteur
            </h1>
  ...
  <g id="Group_64" data-name="Group 64" transform="translate(-600.001 -166)">
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <section className="py-12">
        ...
        Trouvez votre déménageur
        </h2>
        
        <p className="text-gray-600 mb-6">
        Le déménagement d'une maison se réalise en plusieurs étapes. La distance qui sépare les deux logements et la quantité de meubles et cartons à déplacer rendent l'étape plus ou moins longue. Profiter d'un déménagement rapide et efficace grâce aux transporteurs particuliers vous octroie de nombreux avantages. Une fois les dimensions de tous les meubles et le nombre de cartons que vous souhaitez faire transporter spécifiés, les transporteurs intéressés par votre requête pourront vous contacter.
        </p>
      ...
      <section className="py-12">
        <h2 className="text-2xl md:text-3xl font-bold text-center text-gray-800 mb-8">
        Les transporteurs particuliers, vérifiés et notés
        </h2>
        
        <p className="text-gray-600 mb-6">
        Les communautés de voyageurs sont disponibles régulièrement pour vous faire profiter de leurs trajets et opter pour un déménagement à moindre coût. En effet, cette pratique écoresponsable est largement mise en avant. C'est une manière privilégiée de pouvoir déménager simplement. Les particuliers qui possèdent des véhicules utilitaires peuvent en effet effectuer le transport de vos gros meubles (télévision, canapé, buffet, table, etc.)
        </p>
...
<section className="py-12">
        <div className="text-center mb-12">
          ...
          Comment déménager votre maison?
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Proposez  une demande du déménagement de votre maison. Détaillez votre annonce avec l'adresse, les dimensions et le prix
              proposé pour la livraison. Pensez à ajouter une photo de votre maison.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Les voyageurs vous contactent par texto ou mail. Mettez-vous d'accord sur les détails du déménagements de votre maison  (prix, date d'enlèvement et de livraison).
            </p>
          </div>
