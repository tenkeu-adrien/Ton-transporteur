...
//   useEffect(() => {
//     // URL de base pour Socket.io (même domaine que l'application)
//     const socketUrl = process.env.NEXT_PUBLIC_SOCKET_SERVER || window.location.origin;
    
//     // Configuration de la connexion Socket.io
//     const socket = io(socketUrl, {
//       path: "/api/socket.io", // Doit correspondre au path du serveur
//       transports: ['websocket'],
//       autoConnect: true // On laisse Socket.io gérer la connexion
//     });
...
//   return (
//     <>
//       {/* Modale pour les nouvelles notifications */}
//       {newNotification && (
//         <div className="fixed top-4 right-4 z-9999 w-80 bg-white dark:bg-boxdark rounded-lg shadow-lg border border-stroke dark:border-strokedark p-4">
//           <div className="flex justify-between items-start">
//             <div>
//               <h4 className="font-medium text-black dark:text-white">
//                 {newNotification.title}
//               </h4>
//               <p className="text-sm mt-1">{newNotification.message}</p>
//             </div>
//             <button 
//               onClick={closeModal}
//               className="text-bodydark2 hover:text-black dark:hover:text-white"
//             >
//               ✕
//             </button>
//           </div>
