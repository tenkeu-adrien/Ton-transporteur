  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        // Filtrer les envois selon le rôle de l'utilisateur
        if (user?.role === "expediteur") {
          shipmentQuery = query(shipmentsRef, where("expediteurId", "==", user.uid));
        } else {
          // Pour l'admin, récupérer tous les envois
          shipmentQuery = query(shipmentsRef);
        }
  ...
  return (
    <>
      {/* <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Total colis" total="$3.456K" rate="0.43%" levelUp>
          <svg
        ...
        <CardDataStats title="Total colis livrer" total="$45,2K" rate="4.35%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
        ...
        <CardDataStats title="Total colis en attente" total="2.450" rate="2.59%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="22"
        ...
        <CardDataStats title="Total colis annuler" total="3.456" rate="0.95%" levelDown>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="18"
...
<div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
      ...
      <CardDataStats
        ...
        levelUp
      >
        <FaCheckCircle className="fill-primary dark:fill-white" size={22} />
      </CardDataStats>
      ...
      <CardDataStats
        ...
        levelDown
      >
        <FaTimesCircle className="fill-primary dark:fill-white" size={22} />
      </CardDataStats>
    </div>
